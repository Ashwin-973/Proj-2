...
app.set('views',"C:\\Users\\Ashwi\\Documents\\Web Development\\WebDEV\\Proj2\\Day 31-40\\Views")
app.use(express.urlencoded({extended:true}))
app.use(express.json())
//Route navigator: control directed to user.js under Router whenever the endpoint of the base url is /users
app.use('/users',userRoute)
app.use(express.static("C:\\Users\\Ashwi\\Documents\\Web Development\\WebDEV\\Proj2\\Day 31-40\\public"))
